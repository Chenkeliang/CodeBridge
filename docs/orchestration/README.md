...
状态：首个可运行基线；WorkItem、Domain Event、SQLite Event Store、Workflow DSL/Plan IR、WorkItem API 和 queued Run API 已落地，Workflow 执行、Agent 调度、审批、Discovery 和 Web UI 按后续切片接入。
