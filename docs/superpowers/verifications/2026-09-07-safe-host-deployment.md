...
| Agent | fcb deploy -> existing authenticated API -> active native-owned Run/delivery context | publish intent required; no direct restart needed; source directory supplied | fcb HTTP tests and native-context authorization tests pass |
