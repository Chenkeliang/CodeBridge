import type { ChannelSessionEvent, ChannelSessionIngress } from "@codebridge/core";
import { describe, expect, it, vi } from "vitest";
import { TelegramSessionWatcher, type PendingTurn } from "./telegram-session-watcher.js";
