...
const agents: AgentProfile[] = [
  { agent_id: "codex", display_name: "Codex", adapter: "acp", status: "healthy", capabilities: [], models: [], session_features: [] },
  { agent_id: "pi", display_name: "Pi", adapter: "sdk", status: "healthy", capabilities: [], models: [], session_features: [] },
  { agent_id: "cursor", display_name: "Cursor", adapter: "acp", status: "healthy", capabilities: [], models: [], session_features: [] },
  { agent_id: "claude", display_name: "Claude Code", adapter: "acp", status: "healthy", capabilities: [], models: [], session_features: [] },
  { agent_id: "opencode", display_name: "OpenCode", adapter: "acp", status: "unavailable", capabilities: [], models: [], session_features: [] },
];
...
const flows: FlowRecord[] = [
  { flow_id: "f1", name: "仓库巡检", kind: "runbook", status: "published", source: "catalog", definition_revision: "3" },
  { flow_id: "f2", name: "发布验证", kind: "guide", status: "published", source: "catalog", definition_revision: "1" },
];
