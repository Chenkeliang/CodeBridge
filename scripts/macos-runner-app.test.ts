...
describe("macOS Runner app identity", () => {
  it("uses one stable bundle id and executable path", () => {
    expect(runnerAppInfo("/Users/tester")).toEqual({
      bundleId: "com.codebridge.runner",
      appPath: "/Users/tester/Applications/CodeBridge Runner.app",
      executablePath:
        "/Users/tester/Applications/CodeBridge Runner.app/Contents/MacOS/CodeBridgeRunner",
    });
  });
